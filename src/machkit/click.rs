...
impl UiState {
    ...
    pub fn handle_modal_click(
        ...
        let clicked_outside = !modal_rect.contains(mx, my);
        ...
        if modal == ModalType::Settings {
            ...
            && let Some(action) = self.handle_unsaved_changes_modal_click(
                mx,
                my,
                modal_x,
                modal_y,
    ...
    pub fn handle_workspace_click(
        ...
        if my >= status_y {
            ...
            let err_text_w = err_val_str.chars().count() as f32 * self.ui_char_width;
            let warn_text_w = warn_val_str.chars().count() as f32 * self.ui_char_width;
