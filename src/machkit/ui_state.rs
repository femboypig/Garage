...
pub struct UiState {
    ...
    pub global_search_cursor_row: usize,
    pub global_search_selection_anchor: Option<(usize, usize)>,
    pub unsaved_project_search_files: std::collections::HashSet<std::path::PathBuf>,
...
impl UiState {
    ...
    pub fn new(
        ...
        let mut state = Self {
            ...
            global_search_col: 0,
            global_search_cursor_row: 0,
            global_search_selection_anchor: None,
            unsaved_project_search_files: std::collections::HashSet::new(),
