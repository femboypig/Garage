...
pub enum VisualDiagnosticLine {
    ...
    Code { path: String, line_idx: usize, line_content: String, is_diagnostic_line: bool, diag: crate::editor::DiagnosticDetail },
    Banner { path: String, diag: crate::editor::DiagnosticDetail },
}
...
pub fn draw_text_area(
    ...
    for line_idx in start_idx..end_idx {
        ...
        for (char_idx, c) in line_text.chars().enumerate() {
            ...
            pen_x += ui.push_char(vertices, indices, atlas, queue, c, pen_x, baseline_y, default_color, ui.buffer_font_size, ui.buffer_char_width);
        }
