...
impl Theme {
    ...
    pub fn dracula() -> Self {
        Self {
            ...
            titlebar_bg: [0.13, 0.14, 0.19, 1.0],
            titlebar_border: [0.08, 0.085, 0.11, 1.0],
            titlebar_text: [0.97, 0.97, 0.95, 1.0],
            titlebar_hover_bg: [0.27, 0.28, 0.35, 1.0],
            titlebar_brand_text: [1.0, 0.47, 0.78, 1.0],
            
            sidebar_bg: [0.13, 0.14, 0.19, 1.0],
            sidebar_border: [0.08, 0.085, 0.11, 1.0],
            sidebar_text_dir: [0.74, 0.58, 0.98, 1.0],
            sidebar_text_file: [0.97, 0.97, 0.95, 1.0],
            sidebar_selected_bg: [0.27, 0.28, 0.35, 1.0],
            sidebar_hover_bg: [0.27, 0.28, 0.35, 0.5],
            
            tabbar_bg: [0.13, 0.14, 0.19, 1.0],
            tabbar_border: [0.08, 0.085, 0.11, 1.0],
            tab_active_bg: [0.16, 0.16, 0.21, 1.0],
            tab_inactive_bg: [0.13, 0.14, 0.19, 1.0],
            tab_text: [0.97, 0.97, 0.95, 1.0],
            
            breadcrumb_bg: [0.16, 0.16, 0.21, 1.0],
            breadcrumb_border: [0.08, 0.085, 0.11, 1.0],
            breadcrumb_text: [0.55, 0.91, 0.99, 1.0],
            
            editor_bg: [0.16, 0.16, 0.21, 1.0],
            gutter_bg: [0.16, 0.16, 0.21, 1.0],
            gutter_border: [0.08, 0.085, 0.11, 0.0],
            active_line_bg: [0.27, 0.28, 0.35, 0.3],
            line_number_active: [1.0, 0.72, 0.42, 1.0],
            line_number_inactive: [0.38, 0.45, 0.64, 1.0],
            selection_bg: [0.27, 0.28, 0.35, 0.6],
            cursor_color: [0.97, 0.97, 0.95, 1.0],
            
            syntax_default: [0.97, 0.97, 0.95, 1.0],
            syntax_keyword: [1.0, 0.47, 0.78, 1.0],
            syntax_type: [0.55, 0.91, 0.99, 1.0],
            syntax_number: [0.74, 0.58, 0.98, 1.0],
            syntax_string: [0.95, 0.98, 0.55, 1.0],
            syntax_comment: [0.38, 0.45, 0.64, 1.0],
            syntax_attribute: [0.31, 0.98, 0.48, 1.0],
            
            scrollbar_track: [0.16, 0.16, 0.21, 1.0],
            scrollbar_border: [0.08, 0.085, 0.11, 1.0],
            scrollbar_thumb: [0.27, 0.28, 0.35, 0.6],
            scrollbar_thumb_hover: [0.27, 0.28, 0.35, 0.9],
            
            statusbar_bg: [0.13, 0.14, 0.19, 1.0],
            statusbar_border: [0.08, 0.085, 0.11, 1.0],
            statusbar_text: [0.97, 0.97, 0.95, 1.0],
            
            modal_bg: [0.16, 0.16, 0.21, 1.0],
            modal_border: [0.74, 0.58, 0.98, 0.5],
            modal_text_title: [1.0, 0.47, 0.78, 1.0],
            modal_text_normal: [0.97, 0.97, 0.95, 1.0],
            modal_text_muted: [0.38, 0.45, 0.64, 1.0],
            button_bg: [0.27, 0.28, 0.35, 1.0],
            button_hover_bg: [0.27, 0.28, 0.35, 0.7],
            button_border: [0.74, 0.58, 0.98, 0.5],
            button_text: [0.97, 0.97, 0.95, 1.0],
            dropdown_hover_bg: [0.27, 0.28, 0.35, 1.0],
        }
    }
}
